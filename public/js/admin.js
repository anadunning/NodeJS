  ...
  socket.emit("admin_list_messages_by_user", params, (messages) => {
    ...
    messages.forEach(message => {
      ...
      if (message.admin_id === null) {
        ...
        createDiv.innerHTML += `<span class="admin_date">${daysjs(message.created_at).format("DD/MM/YYYY HH:mm:ss")}</span>`;
      } else {
...
socket.on("admin_receive_message", (data) => {
  ...
  createDiv.className = "admin_message_client";
        ...
        createDiv.innerHTML += `<span class="admin_date">${daysjs(data.message.created_at).format("DD/MM/YYYY HH:mm:ss")}</span>`;
